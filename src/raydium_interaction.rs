...
pub fn add_liquidity(pool: String, amount_a: f64, amount_b: f64, min_price: f64, max_price: f64) {
...
pub fn create_pool(pool_config: &ClientConfig, config_index: u16, price: f64, mint0: Pubkey, mint1: Pubkey, open_time: u64) -> anyhow::Result<()> {   
    println!(
